...
public class CSVreader {
   ...
   // static ArrayList<WordData> words2;
    ...
    public void readFromCSV(InputStream inputstream) throws IOException {
        ...
        for(int row = 0; row < csvList.size(); row++) {
            ...
            WordCons worddata = new WordCons(word, weight, pronunciation, verb, verbt, verbi, noun,
                    adj, adv, prep, conj, sentence, looklike, homoionym, antonym);
            ...
            if(worddata.word != null) {
                ...
                WordCons worddata2 = new WordCons("word", 1, "pronunciation",
                        "verb", "verbt", "verbi", "noun", "adj",
                        "adv", "prep", "conj", "sentence",
                        "looklike", "homoionym", "antonym");
                words.add(worddata2);
            }
    ...
    public ArrayList getList() { return words; }

    public String getList(int index) {
        String contains = "";
        contains += words.get(index).word;
        return contains;
    }

    public WordCons getListA(int index) {
